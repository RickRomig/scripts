...
# Created      : 26 Oct 2023
# Last updated : 26 Oct 2023 (Version 0.1.0)
...
day=$(date +%a)
snar="projects.sngz"
archive="projects.$dow-$arc_date.tar.gz"
...
tar -czg "$arc_dir/$snar" -f /"$arc_dir/$archive" - C "$HOME" Projects

rsync -a --delete "$arc_dir"/ rick@192.168.0.16:Downloads/archives/projects-repo/
